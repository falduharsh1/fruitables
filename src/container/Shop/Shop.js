  ...
  return (
    <div className={`container-fluid fruite py-5 ${Theme.Theme}`}>
      ...
      <div className="container py-5">
        <h1 className="mb-4" style={{ color: Theme.Theme === 'light' ? 'black' : 'white' }}>Fresh fruits shop</h1>
            ...
            <div className="row g-4">
              ...
              <div className="col-xl-3">
                <div className="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                  <label htmlFor="fruits" style={{ color: 'black' }}>Default Sorting: </label>
            ...
            <div className="row g-4">
              <div className="col-lg-3">
                <div className="row g-4">
                  ...
                  <div className="col-lg-12">
                    <div className="mb-3">
                      <h4 style={{ color: Theme.Theme === 'light' ? 'black' : 'white' }}>Categories</h4>
                      <br></br>
                  ...
                  <Box sx={{ width: 300, p: 2 }}>
                    <Typography variant="h6" style={{color : 'white'}}>Price: ₹{price}</Typography>
                    <Slider
                      // style={{color : green}}
                      value={price}
                          ...
                          <NavLink to={"/ShopDetail/" + v._id}>
                            <div className="rounded position-relative fruite-item">
                              ...
                              <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                <h4 key={v._id} value={v._id} style={{ color: Theme.Theme === 'light' ? 'black' : 'white' }}> {v.name}  </h4>
                                <p>{v.description}</p>
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                  <p className="fs-5 fw-bold mb-0" style={{ color: Theme.Theme === 'light' ? 'black' : 'white' }}>{v.price + ' ₹/kg'}</p>
